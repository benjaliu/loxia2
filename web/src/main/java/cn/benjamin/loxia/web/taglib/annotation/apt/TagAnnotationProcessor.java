 ...
 * under the License.
 */
package cn.benjamin.loxia.web.taglib.annotation.apt;
...
public class TagAnnotationProcessor implements AnnotationProcessor {
	public static final String LOXIA_TAG = "cn.benjamin.loxia.web.taglib.annotation.LoxiaTag";
	public static final String LOXIA_TAG_ATTRIBUTE = "cn.benjamin.loxia.web.taglib.annotation.LoxiaTagAttribute";
    public static final String TAG_ATTRIBUTE = "org.apache.struts2.views.annotations.StrutsTagAttribute";
	public static final String LOXIA_TAG_SKIP_HIERARCHY = "cn.benjamin.loxia.web.taglib.annotation.LoxiaTagSkipInheritance";
